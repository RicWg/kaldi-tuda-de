...
# Richard: 03042021, only use basic data
...
add_swc_data=false # true
add_mailabs_data=false #true
add_commonvoice_data=false #true
...
[ ! -L "rnnlm" ] && ln -s /opt/kaldi/scripts/rnnlm/
